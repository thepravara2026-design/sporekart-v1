...
class ProductDomainTest {
    ...
    void shouldCreateProductWithValidArguments() {
        Product product = Product.create("sp-shi-001", "Shiitake Spores", "Fresh spores", new BigDecimal("19.99"), "USD", null);
    ...
    void shouldRejectBlankSku() {
        assertThrows(IllegalArgumentException.class, () ->
                Product.create("  ", "Shiitake Spores", "Desc", new BigDecimal("19.99"), "USD", null));
    }

    @Test
    void shouldRejectBlankName() {
        assertThrows(IllegalArgumentException.class, () ->
                Product.create("SP-SHI-001", "", "Desc", new BigDecimal("19.99"), "USD", null));
    }

    @Test
    void shouldRejectNegativePrice() {
        assertThrows(IllegalArgumentException.class, () ->
                Product.create("SP-SHI-001", "Shiitake", "Desc", new BigDecimal("-5.00"), "USD", null));
    }

    @Test
    void shouldAllowLifecycleStatusTransition() {
        Product product = Product.create("SP-SHI-001", "Shiitake Spores", "Desc", new BigDecimal("19.99"), "USD", null);
