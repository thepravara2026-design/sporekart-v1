...
public class CatalogDataSeeder implements CommandLineRunner {
    ...
    private void createAndSaveProduct(String sku, String name, String description, BigDecimal price, String currency, ProductStatus status, Category category) {
        Product p = Product.create(sku, name, description, price, currency, category);
