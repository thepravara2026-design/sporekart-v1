...
export const validateAddress = (address: AddressDto): AddressErrors => {
...
/**
 * AddressForm — collects the shipping address persisted as the order's
 * AddressSnapshot. The backend has no saved address book, so the address is
 * entered inline per order. Validation is client-side convenience; the backend
 * remains the source of truth for address acceptance.
 */
